...
impl DynsU {
    fn make_a() -> Self {
        black_box(DynsU { a: ManuallyDrop::new(As { inner: vec![A { inner: 123}; 10]})} )
    }
    fn make_b() -> Self {
        black_box(DynsU { b: ManuallyDrop::new(Bs { inner: vec![B { inner: 123 }; 10]})} )
    }
    fn make_c() -> Self {
        black_box(DynsU { c: ManuallyDrop::new(Cs { inner: vec![C { inner: 123 }; 10]})} )
    }
...
pub fn bench(c: &mut Criterion) {
    ...
    c.bench_function("union dyn", |b| {
        b.iter_batched(
            || (Dyns::make_a(), Dyns::make_b(), Dyns::make_c()),
            |(mut xs, mut ys, mut zs)| for i in 0..black_box(10) {
                black_box(xs.append_u(DynU { a: A { inner: 123 }} ));
                black_box(ys.append_u(DynU { b :B { inner: 333 }} ));
                black_box(zs.append_u(DynU { c: C { inner: 444 }} ));
            },
            BatchSize::SmallInput,
        )
    });
    ...
    c.bench_function("union dyns and dyn outer match", |b| {
        b.iter_batched(
            || ((DynE::A, DynsU::make_a()), (DynE::B, DynsU::make_b()), (DynE::C, DynsU::make_c())),
            |((da, mut xs), (db, mut ys), (dc, mut zs))| {

                 for i in 0..black_box(10) {
                    black_box(xs.append_u(da, DynU { a: A { inner: 123 }} ));
                    black_box(ys.append_u(db, DynU { b :B { inner: 333 }} ));
                    black_box(zs.append_u(dc, DynU { c: C { inner: 444 }} ));
                 }
                black_box(drop(xs));
                black_box(drop(ys));
                black_box(drop(zs));
    ...
    c.bench_function("union dyns and dyn", |b| {
        b.iter_batched(
            ...
            |(mut xs, mut ys, mut zs)| {
                 ...
                 for i in 0..black_box(10) {
                    black_box(xs.append_u(DynE::A, DynU { a: A { inner: 123 }} ));
                    black_box(ys.append_u(DynE::B, DynU { b :B { inner: 333 }} ));
                    black_box(zs.append_u(DynE::C, DynU { c: C { inner: 444 }} ));
                 }
                black_box(drop(xs));
                black_box(drop(ys));
                black_box(drop(zs));
    ...
    c.bench_function("union dyns and dyn no disc", |b| {
        b.iter_batched(
            ...
            |(mut xs, mut ys, mut zs)| {
                unsafe {
                 for i in 0..black_box(10) {
                    black_box((*xs.a).append_u(DynU { a: A { inner: 123 }} ));
                    black_box((*ys.b).append_u(DynU { b :B { inner: 333 }} ));
                    black_box((*zs.c).append_u(DynU { c: C { inner: 444 }} ));
                 }
                }
                black_box(drop(xs));
                black_box(drop(ys));
